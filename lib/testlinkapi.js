...
var methods_user = require("./user_methods");
util.inherits(TestLinkApi, methods_user);
...
TestLinkApi.prototype.getTestCaseIDByName = function(params, callback) {
	...
	addValueTypeObject(obj, "devKey", this.devkey, "string");
	addValueTypeObject(obj, "testcasename", params.testcasename, "string");
	postToAPI(this.url, obj, callback);
};
...
TestLinkApi.prototype.getTestPlanByName = function(params, callback) {
	...
	addValueTypeObject(obj, "devKey", this.devkey, "string");
	addValueTypeObject(obj, "testprojectname", params.testprojectname, "string");
	addValueTypeObject(obj, "testplanname", params.testplanname, "string");
	postToAPI(this.url, obj, callback);
};
...
TestLinkApi.prototype.createTestCase = function(params, callback) {
	...
	addValueTypeObject(obj, "devKey", this.devkey, "string");
	addValueTypeObject(obj, "testprojectid", params.testprojectid, "int");
	addValueTypeObject(obj, "testsuiteid", params.testsuiteid, "int");
	addValueTypeObject(obj, "testcasename", params.testcasename, "string");
	addValueTypeObject(obj, "authorlogin", params.authorlogin, "string");
	addValueTypeObject(obj, "summary", params.summary, "string");
	addValueTypeObject(obj, "steps", params.steps, "string");
	optionalAddValueTypeObject(obj, "execution", params.execution, "int");
	optionalAddValueTypeObject(obj, "checkduplicatedname", params.checkduplicatedname, "boolean");
	optionalAddValueTypeObject(obj, "actiononduplicatedname", params.actiononduplicatedname, "int");
	postToAPI(this.url, obj, callback);
};
