...
TestLinkApi.prototype.reportTCResult = function(params, callback) {
    var post = utilites.postCompose(this.url),
		inputObject = { methodName: "reportTCResult" };

	addValueTypeObject(inputObject, "devKey", this.devkey, "string");
	addValueTypeObject(inputObject, "testplanid", params.testplanid, "int");
	addEitherValueTypeObject(inputObject, "testcaseexternalid", params.testcaseexternalid, "testcaseid", params.testcaseid, "string");
	addValueTypeObject(inputObject, "buildid", params.buildid, "string");
	addValueTypeObject(inputObject, "notes", params.notes, "string");
	addValueTypeObject(inputObject, "status", params.status, "string");
	addValueTypeObject(inputObject, "platformname", params.platformname, "string");
	addValueTypeObject(inputObject, "user", params.user, "string");
	addValueTypeObject(inputObject, "bugid", params.bugid, "string");

	var	body = utilites.getRequestByObject(inputObject);
    utilites.postRequest(post, body, function(response) {
...
TestLinkApi.prototype.reportTCResultOverwrite = function(params, callback) {
	...
	addValueTypeObject(inputObject, "user", params.user, "string");
	addValueTypeObject(inputObject, "bugid", params.bugid, "string");
	addValueTypeObject(inputObject, "overwrite", params.overwrite, "boolean");
...
var addEitherValueTypeObject = function(object, mainKey, mainValueVariable, backupKey, backupValueVariable, objectType){
