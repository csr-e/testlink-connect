...
TestLinkApi.prototype.getFullPath = function(params, callback) {
	...
	u.addValueTypeObject(obj, "devKey", this.devkey, "string");
	u.addValueTypeObject(obj, "nodeid", params.nodeid, "int");
	u.postToAPI(this.url, obj, callback);
};
 ...
 */
TestLinkApi.prototype.reportTCResult = function(params, callback, errCallback) {
    var	obj = { methodName: "reportTCResult" };
    u.addValueTypeObject(obj, "devKey", this.devkey, "string");
    u.addValueTypeObject(obj, "testplanid", params.testplanid, "int");
    u.addValueTypeObjectChoices(obj, "testcaseexternalid", params.testcaseexternalid, "testcaseid", params.testcaseid, "string");
    u.addValueTypeObject(obj, "buildid", params.buildid, "string");
    u.addValueTypeObject(obj, "notes", params.notes, "string");
    u.addValueTypeObject(obj, "status", params.status, "string");
    u.addValueTypeObject(obj, "platformname", params.platformname, "string");
    u.addValueTypeObject(obj, "user", params.user, "string");
    u.addValueTypeObject(obj, "bugid", params.bugid, "string");
    u.optionalAddValueTypeObject(obj, "overwrite", params.overwrite, "boolean");
    u.postToAPI(this.url, obj, callback, errCallback);
};
 ...
 */
TestLinkApi.prototype.getTestLinkVersion = function(callback, errCallback) {
    var	obj = { methodName: "testLinkVersion" };
    u.addValueTypeObject(obj, "devKey", this.devkey, "string");
    console.error("aviso  -- errCallbakc es : " + errCallback);
    u.postToAPI(this.url, obj, callback, errCallback);
};
